...
import { updateImplemento, getImplemento,getTipos,getEstados, getCategorias } from '@/data/implementoData';

const EditImplemento = () => {
...
useEffect(() => {
    getImplemento(params.id).then((res) => {
        {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(params);
    try {
      await updateImplemento(params.id,implemento);
